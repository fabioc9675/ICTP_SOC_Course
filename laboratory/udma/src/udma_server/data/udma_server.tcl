...
proc swapp_get_description {} {
    return "The UDMA Server provides a FreeRTOS lwIP TCP Server application that interprets UDMA commands from the PC and relies on the ComBlock for FPGA interaction."
}
...
proc check_comblock {} {
    set comblock [hsi::get_cells -hier -filter { ip_name == "comblock" }];
    if { [llength $comblock] != 0 } {
        return;
    }

    error "This application requires a ComBlock IP instance present in the hardware."
}
...
proc swapp_is_supported_hw {} {
    # Check if ComBlock IP is present in the system
    check_comblock;

    # Check if Ethernet IP is present in the system
    check_emac_hw;
...
proc generate_comblock_table {} {
    set fid [open "comblock_config.h" "w+"];
    puts $fid "
...
\{
    ...
    for {set i 1 } {$i < [llength $comblock]} {incr i} {
        puts $fid "
   ,\{
        XPAR_COMBLOCK_${i}_DEVICE_ID,
        XPAR_COMBLOCK_${i}_AXIL_BASEADDR,
        XPAR_COMBLOCK_${i}_AXIL_HIGHADDR,
        XPAR_COMBLOCK_${i}_AXIF_BASEADDR,
        XPAR_COMBLOCK_${i}_AXIF_HIGHADDR,
        XPAR_COMBLOCK_${i}_REGS_IN_ENA,
        XPAR_COMBLOCK_${i}_REGS_IN_DWIDTH,
        XPAR_COMBLOCK_${i}_REGS_IN_DEPTH,
        XPAR_COMBLOCK_${i}_REGS_OUT_ENA,
        XPAR_COMBLOCK_${i}_REGS_OUT_DWIDTH,
        XPAR_COMBLOCK_${i}_REGS_OUT_DEPTH,
        XPAR_COMBLOCK_${i}_DRAM_IO_ENA,
        XPAR_COMBLOCK_${i}_DRAM_IO_DWIDTH,
        XPAR_COMBLOCK_${i}_DRAM_IO_AWIDTH,
        XPAR_COMBLOCK_${i}_DRAM_IO_DEPTH,
        XPAR_COMBLOCK_${i}_FIFO_IN_ENA,
        XPAR_COMBLOCK_${i}_FIFO_IN_DWIDTH,
        XPAR_COMBLOCK_${i}_FIFO_IN_DEPTH,
        XPAR_COMBLOCK_${i}_FIFO_IN_AFOFFSET,
        XPAR_COMBLOCK_${i}_FIFO_IN_AEOFFSET,
        XPAR_COMBLOCK_${i}_FIFO_OUT_ENA,
        XPAR_COMBLOCK_${i}_FIFO_OUT_DWIDTH,
        XPAR_COMBLOCK_${i}_FIFO_OUT_DEPTH,
        XPAR_COMBLOCK_${i}_FIFO_OUT_AFOFFSET,
        XPAR_COMBLOCK_${i}_FIFO_OUT_AEOFFSET
     \}";
    }
