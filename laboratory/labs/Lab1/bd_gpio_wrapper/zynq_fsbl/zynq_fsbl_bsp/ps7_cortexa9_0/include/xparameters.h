...
/* Definitions for peripheral PMOD_A_O */
#define XPAR_PMOD_A_O_BASEADDR 0x41200000
#define XPAR_PMOD_A_O_HIGHADDR 0x4120FFFF
#define XPAR_PMOD_A_O_DEVICE_ID 0
#define XPAR_PMOD_A_O_INTERRUPT_PRESENT 0
#define XPAR_PMOD_A_O_IS_DUAL 0


/* Definitions for peripheral PMOD_B_I */
#define XPAR_PMOD_B_I_BASEADDR 0x41210000
#define XPAR_PMOD_B_I_HIGHADDR 0x4121FFFF
#define XPAR_PMOD_B_I_DEVICE_ID 1
#define XPAR_PMOD_B_I_INTERRUPT_PRESENT 0
#define XPAR_PMOD_B_I_IS_DUAL 0


/* Definitions for peripheral LED_O */
#define XPAR_LED_O_BASEADDR 0x41220000
#define XPAR_LED_O_HIGHADDR 0x4122FFFF
#define XPAR_LED_O_DEVICE_ID 2
#define XPAR_LED_O_INTERRUPT_PRESENT 0
#define XPAR_LED_O_IS_DUAL 0


/* Definitions for peripheral SW_I */
#define XPAR_SW_I_BASEADDR 0x41230000
#define XPAR_SW_I_HIGHADDR 0x4123FFFF
#define XPAR_SW_I_DEVICE_ID 3
#define XPAR_SW_I_INTERRUPT_PRESENT 0
#define XPAR_SW_I_IS_DUAL 0


/******************************************************************/

/* Canonical definitions for peripheral PMOD_A_O */
#define XPAR_GPIO_0_BASEADDR 0x41200000
#define XPAR_GPIO_0_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_PMOD_A_O_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral PMOD_B_I */
#define XPAR_GPIO_1_BASEADDR 0x41210000
#define XPAR_GPIO_1_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_PMOD_B_I_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_GPIO_1_IS_DUAL 0

/* Canonical definitions for peripheral LED_O */
#define XPAR_GPIO_2_BASEADDR 0x41220000
#define XPAR_GPIO_2_HIGHADDR 0x4122FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_LED_O_DEVICE_ID
#define XPAR_GPIO_2_INTERRUPT_PRESENT 0
#define XPAR_GPIO_2_IS_DUAL 0

/* Canonical definitions for peripheral SW_I */
#define XPAR_GPIO_3_BASEADDR 0x41230000
#define XPAR_GPIO_3_HIGHADDR 0x4123FFFF
#define XPAR_GPIO_3_DEVICE_ID XPAR_SW_I_DEVICE_ID
