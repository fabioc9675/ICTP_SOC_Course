...
set name fir_mul_12s_32s_32_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler fir_fir_Pipeline_Shift_Accum_Loop_firCoeff_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { x_TVALID { I 1 bit } x_TDATA { I 32 vector } x_TREADY { O 1 bit } } \
} "
} else {
...
# PVB definition:
set ID 0
set PvbName fir_frp_pipeline_valid
set InstName fir_frp_pipeline_valid_U
