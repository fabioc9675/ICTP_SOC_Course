...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { y_TDATA { O 32 vector } y_TVALID { O 1 bit } y_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { x_TDATA { I 32 vector } x_TVALID { I 1 bit } x_TREADY { O 1 bit } } \
} "
} else {
...
# RegSlice definition:
set ID 10
set RegSliceName fir_regslice_both
set RegSliceInstName fir_regslice_both_U
set CoreName ap_simcore_fir_regslice_both
